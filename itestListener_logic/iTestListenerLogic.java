...
public class iTestListenerLogic implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		File destination = new File("C:\\Users\\RC-PC\\Pictures\\Screenshots\\passed"+ Math.random()+".png");
		try {
	...
	public void onTestFailure(ITestResult result) {
		...
		TakesScreenshot p1 = (TakesScreenshot) driver;
		File source =p1.getScreenshotAs(OutputType.FILE);
		File destination = new File("C:\\Users\\RC-PC\\Pictures\\Screenshots\\failed"+ Math.random()+".png");
		try {
			FileHandler.copy(source, destination);
		} catch (IOException e) {
			// TODO Auto-generated catch block
